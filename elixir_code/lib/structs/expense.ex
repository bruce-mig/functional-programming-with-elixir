defmodule ElixirCode.Structs.Expense do
  alias ElixirCode.Structs.Expense
  ...
  def sample do
    [
      %Expense{title: "Grocery", date: ~D[2023-09-12], amount: 18.99, store: "Metro"},
      %Expense{title: "Mobile", date: ~D[2023-10-18], amount: 55.65, store: "Bell"},
